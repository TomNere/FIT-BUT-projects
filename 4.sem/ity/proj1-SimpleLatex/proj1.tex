...
\begin{quotation}
	 Čím více \textsf{druhů}, \textit{\textbf{řezů}}, {\small velikostí}, barev písma a \texttt{jiných efektů} použijeme, tím \textit{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy {\bfseries \huge nadšen!}
\end{quotation}
